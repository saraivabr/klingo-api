...
export const plans = pgTable('plans', {
  ...
  priceSemestralCents: integer('price_semestral_cents'),
...
export const subscriptions = pgTable('subscriptions', {
  ...
  notes: text('notes'),
  igsSyncedAt: timestamp('igs_synced_at', { withTimezone: true }),
  igsProductId: text('igs_product_id'),
  klingoSyncedAt: timestamp('klingo_synced_at', { withTimezone: true }),
  createdAt: timestamp('created_at', { withTimezone: true }).defaultNow(),
}, (table) => ({
