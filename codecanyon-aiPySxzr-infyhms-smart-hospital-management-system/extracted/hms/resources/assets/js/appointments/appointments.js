...
function loadAppointmentTable() {
    ...
    listenClick(".appointment-complete-status", function (event) {
        ...
        completeAppointment(
            ...
            "#appointmentsTbl",
            Lang.get("js.appointment") + " " + Lang.get("js.status")
        );
    });
...
listenChange("#addInQueue", function () {
    let status = $(this).val();
    $.ajax({
        url: "patient-queue/change-status",
        type: "GET",
...
listenClick(".patient-queue-status", function () {
