<div id="add_odontogram_modal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">  
                <h3 class="modal-title"
                    id="exampleModalLabel">{{ __('Add Odontogram') }}</h3>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
            </div>
            {{ Form::open(['id'=>'addOdontogramForm']) }}
            <div class="modal-body">
                <div class="alert alert-danger d-none hide" id="odontogramValidationErrorsBox"></div>
                <div class="row">
                    ...
                    @else
                        <div class="form-group col-sm-6">
                            ...
                            {{ Form::select('patient_id', $patients, null, ['class' => 'form-select', 'required', 'id' => 'odontogramPatientId', 'placeholder' => __('messages.document.select_patient'), 'data-control' => 'select2']) }}
                        </div>
                    @endif
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        @else
                            <div class="form-group col-sm-6 mb-5">
                                ...
                                <span class="required"></span>
                                {{ Form::select('doctor_id', $doctors, null, ['class' => 'form-select', 'required', 'id' => 'odontogramDoctorId', 'placeholder' => __('messages.web_home.select_doctor'), 'data-control' => 'select2']) }}
                            </div>
                        @endif
                </div>
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <span class="required"></span>
                        {{ Form::textarea('description', null, ['class' => 'form-control','required', 'rows' => '6', 'placeholder' => __('messages.appointment.description')]) }}
                    </div>
                    <div class="form-group col-sm-6">
                        {{ Form::hidden('odontogram', '', ['id'=>'odontogram']) }}
                    ...
                    98.3,578.3 88,579 82,575 75,565 69.3,552.3 67.3,542 69.7,536 74.3,531.7 84.3,528.3 	">
                                    ...
                                    <path id="Tooth28"  fill="white" data-key="28"
                    ...
                    190.3,662.7 193,657.3 199.7,647.3 207,638 210.7,635.5 	">
                                    ...
                                    <path id="Tooth24"  fill="white" data-key="24"
                    ...
                    381.3,524.3 374,520.7 363.7,516.3 356.3,515.3 351.3,518.3 346.3,524 340.3,534.3 336,546.7 	">
                                    ...
                                    <path id="Tooth19"  fill="white" data-key="19"
                    ...
                    212.3,75.7 208,83 201.7,85.7 195.7,86.7 189.7,83.3 183.7,74.7 175,62 171.7,54 172.7,49.7 	">
                                    ...
                                    <path id="Tooth7"  fill="white" data-key="7"
                    ...
                    73.7,201 64.3,196.7 60.3,190.7 59,183.3 61.7,175.3 66.3,167.7 71.3,161.3 	">
                                    ...
                                    <path id="Tooth3"  fill="white" data-key="3"
            ...
            <div class="modal-footer">
                {{ Form::button(__('messages.common.save'), ['type'=>'submit','class' => 'btn btn-primary m-0','id'=>'btnOdontogramSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> Processing..."]) }}
