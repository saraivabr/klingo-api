...
<div class="d-flex justify-content-end">
    <button type="submit" class="btn btn-primary {{getCurrentLoginUserLanguageName()=='ar' ? 'ms-2' : 'me-2'}} btnPrescriptionSave" id="editPrescriptionSave">
        {{__('messages.common.save')}}</button>
{{--    {!! Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary me-2 btnPrescriptionSave','id' => 'editPrescriptionSave']) !!}--}}
