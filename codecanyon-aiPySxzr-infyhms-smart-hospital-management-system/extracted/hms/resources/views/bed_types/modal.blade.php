            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('title', null, ['id'=>'BedTypeTitle','class' => 'form-control','required','placeholder'=>__('messages.bed.bed_type')]) }}
                    </div>
                    <div class="form-group col-sm-12">
                        {{ Form::label('description', __('messages.bed_type.description').(':'),['class' => 'form-label']) }}
                        {{ Form::textarea('description', '', ['class' => 'form-control', 'rows' => 3, 'id' => 'BedTypeDescription','placeholder'=>__('messages.bed.description')]) }}
                    </div>
                </div>
            </div>
