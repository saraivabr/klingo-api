        ...
        <div class="dropdown-menu py-0" aria-labelledby="accountantFilterBtn">
            ...
            <div class="p-5">
                <div class="mb-5">
                    ...
                    {{ Form::select('status', localization('filter',$filterHeads[0]), null, ['id' => 'accountant_filter_status', 'data-control' => 'select2', 'class' => 'form-select status-selector select2-hidden-accessible data-allow-clear="true"']) }}
