...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::email('email', null, ['class' => 'form-control', 'required', 'id' => 'nurseEmail', 'placeholder' => __('messages.user.email'), 'autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('dob', null, ['placeholder' => __('messages.user.dob'), 'id' => 'nurseBirthDate', 'class' => getLoggedInUser()->thememode ? 'bg-light nurseBirthDate form-control' : 'bg-white nurseBirthDate form-control', 'autocomplete' => 'off', 'placeholder' => __('messages.user.dob')]) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
