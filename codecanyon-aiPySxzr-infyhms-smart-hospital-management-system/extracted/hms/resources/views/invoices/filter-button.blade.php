<div class="ms-0 ms-md-2" wire:ignore>
    <div class="dropdown d-flex align-items-center {{ getCurrentLoginUserLanguageName() == 'ar' ? 'ms-4' : 'me-4' }} me-md-5"
        id="invoiceFilterDiv">
        ...
        <div class="dropdown-menu py-0" aria-labelledby="invoiceFilterBtn">
            ...
            <div class="p-5">
                <div class="mb-5">
                    ...
                    {{-- {{ Form::select('status', collect($filterHeads[0])->sortBy('key')->toArray(), null,['id' => 'invoice_status_filter', 'data-control' =>'select2', 'class' => 'form-select status-filter']) }} --}}
                    <select class="form-select status-selector " id="invoice_status_filter" data-control="select2"
                        ...
                        <option value="0">{{ __('messages.invoice.paid') }}</option>
                        <option value="1">{{ __('messages.invoice.pending') }}</option>
                    </select>
                </div>
