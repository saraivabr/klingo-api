<div class="ms-0 ms-md-2" wire:ignore>
    <div
        ...
        <button class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0" type="button"
            data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false" id="serviceFilterBtn">
            <i class='fas fa-filter'></i>
        </button>
        <div class="dropdown-menu py-0" aria-labelledby="serviceFilterBtn">
            <div
            ...
            <div class="p-5">
                <div class="mb-5">
                    ...
                    {{ Form::select('status', localization('filter',$filterHeads[0]), null, ['id' => 'service_filter_status', 'data-control' => 'select2', 'class' => 'form-select status-selector select2-hidden-accessible data-allow-clear="true"']) }}
                </div>
