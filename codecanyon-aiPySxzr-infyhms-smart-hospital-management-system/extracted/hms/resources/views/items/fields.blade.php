<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {!! Form::text('unit', null, ['id'=>'itemUnit','class' => 'form-control', 'required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'maxlength' => '4','minlength' => '1','placeholder'=>__('messages.item.unit')]) !!}
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group mb-5">
