<div class="alert alert-danger d-none hide" id="caseHandlerErrorBox"></div>
<div class="row">
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::email('email', null, ['class' => 'form-control', 'required', 'tabindex' => '3', 'id' => 'caseHandlerEmail', 'placeholder' => __('messages.user.email'), 'autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {{ Form::text('dob', null, ['id' => 'caseHandlerBirthDate', 'class' => getLoggedInUser()->thememode ? 'bg-light birthDate form-control' : 'bg-white birthDate form-control', 'autocomplete' => 'off', 'tabindex' => '9', 'placeholder' => __('messages.user.dob')]) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('blood_group', __('messages.user.blood_group') . ':', ['class' => 'form-label']) }}
            {{ Form::select('blood_group', $bloodGroup, null, ['class' => 'form-select', 'id' => 'caseHandlerBloodGroup', 'placeholder' => __('messages.user.select_blood_group'), 'data-control' => 'select2', 'tabindex' => '10']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::password('password', ['class' => 'form-control', 'required', 'min' => '6', 'max' => '10', 'placeholder' => __('messages.user.password'), 'autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            ...
            <span class="required"></span>
            {{ Form::password('password_confirmation', ['class' => 'form-control', 'required', 'min' => '6', 'max' => '10', 'placeholder' => __('messages.user.password_confirmation'), 'autocomplete' => 'off']) }}
        </div>
    </div>
                        ...
                        <span class="picker-edit rounded-circle text-gray-500 fs-small"
                            ...
                            <label>
                                ...
                                <input type="file" id="accountantProfileImage" name="image"
                                    class="image-upload d-none profileImage caseHandlerProfileImage"
...
<div class="d-flex justify-content-end">
    ...
    &nbsp;&nbsp;&nbsp;
    <a href="{{ route('case-handlers.index') }}" class="btn btn-secondary">{{ __('messages.common.cancel') }}</a>
</div>
