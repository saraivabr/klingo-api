...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::email('email', null, ['class' => 'form-control', 'required', 'tabindex' => '3', 'id' => 'pharmacistEmail', 'placeholder' => __('messages.user.email'), 'autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('dob', null, ['class' => getLoggedInUser()->thememode ? 'bg-light pharmacistBirthDate form-control' : 'bg-white pharmacistBirthDate form-control', 'id' => 'pharmacistBirthDate', 'autocomplete' => 'off', 'tabindex' => '9', 'placeholder' => __('messages.user.dob')]) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('blood_group', __('messages.user.blood_group') . ':', ['class' => 'form-label']) }}
            {{ Form::select('blood_group', $bloodGroup, null, ['class' => 'form-select pharmacistBloodGroup', 'id' => 'pharmacistBloodGroup', 'placeholder' => __('messages.user.select_blood_group'), 'data-control' => 'select2', 'tabindex' => '10']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::password('password', ['class' => 'form-control', 'required', 'min' => '6', 'max' => '10', 'tabindex' => '11', 'placeholder' => __('messages.user.password'), 'autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
        ...
        <div class="form-group mb-5 d-flex flex-column">
            ...
            <div class="form-check form-switch mt-3">
                <input
                    ...
                    name="status" type="checkbox" value="1" tabindex="11" checked>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-end">
        {{ Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary ' . (getCurrentLoginUserLanguageName() == 'ar' ? 'ms-2' : 'me-2')]) }}
        <a href="{{ route('pharmacists.index') }}" class="btn btn-secondary">{!! __('messages.common.cancel') !!}</a>
    </div>
