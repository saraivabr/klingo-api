<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('category_id',$data['pathologyCategories'], null, ['class' => 'form-select pathologyCategories','required','id' => 'pathologyCategories','placeholder'=>__('messages.medicine.select_category'),'required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            {{ Form::text('standard_charge', null, ['placeholder' => __('messages.pathology_test.standard_charge'),'class' => 'form-control price-input pathologyStandardCharge', 'id' => 'pTestStandardCharge', 'readonly', 'required']) }}
        </div>
    </div>
    <div class="col-sm-12">
