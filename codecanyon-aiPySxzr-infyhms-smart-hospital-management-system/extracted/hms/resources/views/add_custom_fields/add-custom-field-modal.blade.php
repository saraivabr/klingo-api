        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-5 comma d-none">
                    ...
                    <div class="col-md-6 mb-5 d-flex flex-column">
                        ...
                        <label class="form-check form-switch">
                            <input name="is_required" class="form-check-input {{getCurrentLoginUserLanguageName()== 'ar' ? 'float-end' : 'float-start'}}" type="checkbox"
                                    value="0">
