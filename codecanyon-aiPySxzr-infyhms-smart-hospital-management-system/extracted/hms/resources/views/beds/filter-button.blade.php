<div class="ms-auto" wire:ignore>
    <div
        ...
        <button class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0" type="button"
            data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false" id="bedAssignFilterBtn">
        ...
        <div class="dropdown-menu py-0" aria-labelledby="bedAssignFilterBtn">
            ...
            <div class="p-5">
                <div class="mb-5">
                    ...
                    {{-- {{ Form::select('status', dump($filterHeads[0]),null, ['id' => 'bed_filter_status', 'data-control' =>'select2', 'class' => 'form-select status-selector select2-hidden-accessible data-allow-clear="true"']) }} --}}
                    <select class="form-select status-selector " id="bed_filter_status" data-control="select2"
                        name="status">
                ...
                <div class="d-flex justify-content-end">
                    <button type="reset" id="bedResetFilter"
