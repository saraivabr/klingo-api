...
<script id="purchaseMedicineTemplate" type="text/x-jsrender">
    <tr>
        ...
        <td>
            <input class="form-control purchaseMedicineExpiryDate bg-white" placeholder="<?php echo __('messages.purchase_medicine.expiry_date') ?>"  required="" name="expiry_date[]"  id="expiry_date{{:uniqueId}}" type="text">
        </td>
        <td>
