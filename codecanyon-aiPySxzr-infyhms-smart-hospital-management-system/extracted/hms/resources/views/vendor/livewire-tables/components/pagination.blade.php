            ...
            @if ($component->paginationVisibilityIsEnabled())
                @if ($component->paginationIsEnabled() && $component->perPageVisibilityIsEnabled())
                    <div class="mb-xxl-0 mb-xl-5 mb-3 d-flex align-items-center justify-content-sm-start justify-content-center">
                        <span class="{{getCurrentLoginUserLanguageName() === 'ar' ? 'ms-3' : 'me-3'}} text-gray-600 fs-4 fs-xl-6">@lang('messages.common.show')</span>
                    ...
                    @else
                        <div class="row">
                            <div class="col-12 {{getCurrentLoginUserLanguageName() === 'ar' ? 'me-3' : 'ms-3'}} text-gray-600 fs-4">
                                @lang('Showing')
                                <strong>{{ $rows->count() }}</strong>
                                @lang('results')
                            </div>
