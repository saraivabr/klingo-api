<div class="ms-0 ms-md-2" wire:ignore>
    <div
        ...
        <button class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0" type="button"
            data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false" id="medicineCategoryFilterBtn">
        ...
        <div class="dropdown-menu py-0" aria-labelledby="medicineCategoryFilterBtn">
            ...
            <div class="p-5">
                <div class="mb-5">
                    ...
                    {{ Form::select('status',localization('filter',collect($filterHeads[0])->sortBy('key')->toArray()),null,['id' => 'medicineCategoryHead', 'data-control' => 'select2', 'class' => 'form-select status-selector select2-hidden-accessible data-allow-clear="true"']) }}
                </div>
