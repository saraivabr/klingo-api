<div class="row">
    ...
    <div class="form-group col-sm-6 mb-5">
        ...
        <span class="required"></span>
        {{ Form::select('vehicle_type', $type,null, ['id'=>'ambulanceVehicleType','class' => 'form-select','required','data-control' => 'select2', 'placeholder' => __('messages.ambulance.vehicle_type')]) }}
    </div>
