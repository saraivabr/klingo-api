            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <span class="required"></span>
                        {{ Form::select('charge_type', $chargeTypes, null, ['class' => 'form-select','required','id' => 'chargeCategoryTypeId','placeholder'=> __('messages.common.choose').' '.__('messages.charge_category.charge_type')]) }}
                    </div>
                </div>
            </div>
