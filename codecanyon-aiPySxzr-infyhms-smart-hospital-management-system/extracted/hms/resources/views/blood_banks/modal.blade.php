            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('blood_group', '', ['id'=>'bloodGroupName','class' => 'form-control','required','placeholder'=>__('messages.hospital_blood_bank.blood_group')]) }}
                    </div>
                    <div class="form-group col-sm-12">
                        {{ Form::label('remained_bags', __('messages.hospital_blood_bank.remained_bags').(':'),['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::number('remained_bags', '', ['id'=>'bloodBankRemainedBags','class' => 'form-control','required','min' => 1,'placeholder'=>__('messages.hospital_blood_bank.remained_bags')]) }}
                    </div>
