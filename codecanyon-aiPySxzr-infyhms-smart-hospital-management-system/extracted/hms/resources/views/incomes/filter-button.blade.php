        ...
        <div class="dropdown-menu py-0" aria-labelledby="incomeFilterBtn">
            ...
            <div class="p-5">
                <div class="mb-5">
                    ...
                    {{ Form::select('income_head', localization('incomes', $filterHeads[0]), null, ['id' => 'incomeHead', 'data-control' => 'select2', 'class' => 'form-select status-filter']) }}
                </div>
                <div class="d-flex justify-content-end">
                    <button type="reset" class="btn btn-secondary"
                        id="incomeResetFilter">{{ __('messages.common.reset') }}</button>
                </div>
            </div>
        </div>
    </div>
