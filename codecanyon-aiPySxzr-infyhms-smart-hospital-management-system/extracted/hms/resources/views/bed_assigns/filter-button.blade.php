        ...
        <div class="dropdown-menu py-0" aria-labelledby="bedAssignFilterBtn">
            ...
            <div class="p-5">
                <div class="mb-10">
                    ...
                    {{ Form::select('account_status', localization('filter', $component->FilterComponent[1]), null, ['id' => 'bed_assigns_filter_status', 'data-control' => 'select2', 'class' => 'form-select role-selector select2-hidden-accessible data-allow-clear="true"']) }}
                </div>
