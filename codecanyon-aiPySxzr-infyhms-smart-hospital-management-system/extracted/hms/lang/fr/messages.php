...
return [
    ...
    */
    ...
    'custom_serial' => 'Numéro de série personnalisé',
    'custom_serial_prefix' => 'Préfixe du numéro de série personnalisé',
    'prefix_tooltip' => 'Entrez un préfixe contenant des lettres et des chiffres (ex : ABC, ABC01). Le système incrémentera automatiquement le dernier chiffre (ABC01 → ABC02). Si aucun chiffre n’est trouvé, la numérotation commencera à 1 ou à votre numéro de départ défini.',
    ...
    'bill' => [
        ...
        'note_Bill' => 'Remarque : Après avoir ajouté les frais, vous devrez régénérer la facture.',
    ...
    'appointment' => [
        ...
        'time' => 'Temps',
        'failed_to_validate_recaptcha' => 'Échec de la vérification ReCaptcha',
        'you_can_not_delete' => 'Le rendez-vous ne peut pas être supprimé.',
    ],
    ...
    'currency' => [
        ...
        'in_use_cannot_delete' => 'en cours d\'utilisation, impossible de supprimer'
    ],
    ...
    'enquiry' => [
        ...
        [
            ...
            'residential_care' => 'Soins résidentiel',
    ...
    'expense_head' => [
        'All' => 'Tous',
        'Building Rent' => 'Loyer de Bâtiment',
        'Equipments' => 'Équipements',
        'Electricity Bill' => 'Facture d’Électricité',
        'Power Generator Fuel Charge' => 'Frais de Carburant pour Générateur',
        'Telephone Bill' => 'Facture de Téléphone',
        'Tea Expense' => 'Dépenses de Thé',
    ],
    ...
    'incomes' => [
        'All' => 'Tous',
        'Hospital Charges' => 'Frais d’Hôpital',
        'Special Campaign' => 'Campagne Spéciale',
        'Canteen Rent' => 'Loyer de Cantine',
        'Vehicle Stand Charges' => 'Frais de Stationnement',
    ...
    'vaccination' => [
        ...
        'brand' => 'Marque',
        'vaccinated' => 'Vacciné',
        'select_vaccination' => 'Sélectionnez Vaccination',
    ],
    ...
    'addon' => [
        'addon' => 'Ajouter sur',
        'upload_addon' => 'Télécharger le module complémentaire',
        'zip_required_file' => 'Le fichier ZIP ne contient pas les fichiers requis. Veuillez vérifier et réessayer.',
        'addon_uploaded_successfully' => 'Fichier téléchargé et extrait avec succès.',
        'failed_to_extraction' => 'Échec de l\'ouverture du fichier zip pour l\'extraction.',
        'failed_to_open' => 'Échec de l\'ouverture du fichier zip.',
        'module_folder_already_exists' => 'Le dossier du module existe déjà.',
        'module_status_updated' => 'Statut du module Mis à jour avec succès',
        'disable' => 'Désactiver',
        'enable' => 'Activer',
    ],
    'queue' => [
        'patient_queue_system' => 'Système de gestion de file d’attente des patients',
        'live_updates' => 'Mises à jour en direct',
        'currently_serving' => 'Actuellement en service',
        'waiting' => 'En attente',
        'auto_refresh' => 'Rafraîchissement automatique dans',
        'queue' => 'File d’attente',
        'patient_name' => 'Nom du patient',
        'attending_doctors' => 'Médecins traitants',
        'status' => 'Statut',
        'no_patients_in_queue' => 'Aucun patient dans la file d’attente',
    ],
];
