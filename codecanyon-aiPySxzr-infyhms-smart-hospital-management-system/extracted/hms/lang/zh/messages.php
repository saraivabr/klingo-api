...
return [
    ...
    */
    ...
    'custom_serial' => '自定义序列号',
    'custom_serial_prefix' => '自定义序列号前缀',
    'prefix_tooltip' => '请输入包含字母和数字的前缀（例如：ABC，ABC01）。系统会自动递增最后的数字（ABC01 → ABC02）。如果未找到数字，编号将从1或您设置的起始编号开始。',
    ...
    'appointment' => [
        ...
        'time' => '时间',
        'failed_to_validate_recaptcha' => 'ReCaptcha 验证失败',
        'you_can_not_delete' => '预约无法删除。',
    ],
    ...
    'expense_head' => [
        ...
        'Equipments' => '设备',
        'Electricity Bill' => '电费',
        'Power Generator Fuel Charge' => '发电机燃料费用',
        'Telephone Bill' => '电话费',
        'Tea Expense' => '茶水费',
    ],
    ...
    'incomes' => [
        'All' => '所有',
        'Hospital Charges' => '医院费用',
        'Special Campaign' => '特别活动',
        'Canteen Rent' => '食堂租金',
        'Vehicle Stand Charges' => '车辆停车费',
    ...
    'addon' => [
        ...
        'module_status_updated' => '模块状态 更新成功',
        'disable' => '禁用',
        'enable' => '使能够',
    ],
    'queue' => [
        'patient_queue_system' => 'Hasta Kuyruk Yönetim Sistemi',
        'live_updates' => 'Canlı Güncellemeler',
        'currently_serving' => 'Şu anda hizmet veriliyor',
        'waiting' => 'Bekliyor',
        'auto_refresh' => 'Otomatik yenileme',
        'queue' => 'Kuyruk',
        'patient_name' => 'Hasta Adı',
        'attending_doctors' => 'İlgilenen Doktorlar',
        'status' => 'Durum',
        'no_patients_in_queue' => 'Kuyrukta hasta yok',
    ],
];
