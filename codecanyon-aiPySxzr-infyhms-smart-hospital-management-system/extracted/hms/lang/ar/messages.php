...
return [
    ...
    */
    ...
    'custom_serial' => 'الرقم التسلسلي المخصص',
'custom_serial_prefix' => 'بادئة الرقم التسلسلي المخصص',
'prefix_tooltip' => 'أدخل أي بادئة تحتوي على حروف وأرقام (مثال: ABC، ABC01). سيقوم النظام بزيادة الرقم الأخير تلقائيًا (ABC01 → ABC02). إذا لم يتم العثور على رقم، فسيبدأ الترقيم من 1 أو من رقم البداية الذي قمت بتعيينه.',
    ...
    'bill' => [
        ...
        'manually' => 'يدويا',
        'note_Bill' => 'ملاحظة: بعد إضافة الرسوم، يجب عليك إعادة إنشاء الفاتورة.',
        'stripe' => 'شريط',
        'approved' => 'موافقة',
        'rejected' => 'مرفوض',
    ...
    'appointment' => [
        ...
        'time' => 'وقت',
        'failed_to_validate_recaptcha' => 'فشل التحقق من ReCaptcha.',
        'you_can_not_delete' => 'لا يمكن حذف الموعد.',
    ],
    ...
    'currency' => [
        ...
        'in_use_cannot_delete' => 'قيد الاستخدام لا يمكن حذف'
    ],
    ...
    'enquiry' => [
        ...
        'types' =>
        [
            'general_enquiry' => 'استفسار عام',
            'residential_care' => 'الرعاية السكنية',
    ...
    'charge' => [
        ...
        'Supplier' => 'المورد',
        'Operation Theatre' => 'غرفة العمليات',
        'Others' => 'أخرى',
    ],
    ...
    [
        'All' => 'كل',
        'Building Rent' => 'إيجار المبنى',
        'Equipments' => 'المعدات',
        'Electricity Bill' => 'فاتورة الكهرباء',
        'Power Generator Fuel Charge' => 'رسوم وقود المولد الكهربائي',
        'Telephone Bill' => 'فاتورة الهاتف',
        'Tea Expense' => 'مصاريف الشاي',
    ],
    ...
    'incomes' => [
        ...
        'document_error' => 'يجب أن تكون الوثيقة من نوع: jpeg، jpg، png، pdf، doc، docx.',
        'All' => 'كل',
        'Hospital Charges' => 'رسوم المستشفى',
        'Special Campaign' => 'حملة خاصة',
        'Canteen Rent' => 'إيجار الكافتيريا',
        'Vehicle Stand Charges' => 'رسوم وقوف السيارات',
    ],
    ...
    'addon' => [
        ...
        'module_status_updated' => 'تم تحديث حالة الوحدة بنجاح',
        'disable' => 'إبطال',
        'enable' => 'يُمكَِن',
    ],

    'queue' => [
        'patient_queue_system' => 'نظام إدارة طابور المرضى',
        'live_updates' => 'تحديثات مباشرة',
        'currently_serving' => 'يتم الخدمة حاليًا',
        'waiting' => 'في الانتظار',
        'auto_refresh' => 'تحديث تلقائي خلال',
        'queue' => 'الطابور',
        'patient_name' => 'اسم المريض',
        'attending_doctors' => 'الأطباء المعالجون',
        'status' => 'الحالة',
