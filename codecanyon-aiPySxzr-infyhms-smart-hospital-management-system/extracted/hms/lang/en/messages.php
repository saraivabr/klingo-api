...
return [
    ...
    */
    ...
    'post' => 'Post',
    'custom_serial' => 'Custom Serial #',
    'custom_serial_prefix' => 'Custom Serial Prefix',
    'prefix_tooltip' => 'Enter any prefix with letters and numbers (e.g., ABC, ABC01). The system will auto-increment the last number (ABC01 → ABC02). If no number is found, numbering starts from 1 or your set start number.',
    ...
    'appointment' => [
        ...
        'time' => 'Time',
        'failed_to_validate_recaptcha' => 'ReCaptcha Verification failed',
        'you_can_not_delete' => 'Appointment cannot delete.',
    ],
    ...
    'currency' => [
        ...
        'in_use_cannot_delete' => 'in use cannot delete'
    ],
    ...
    [
        ...
        'Power Generator Fuel Charge' => 'Power Generator Fuel Charge',
        'Telephone Bill' => 'Telephone Bill',
        'Tea Expense' => 'Tea Expense',
    ],
    ...
    'addon' => [
        ...
        'zip_required_file' => 'The ZIP file is missing required files. Please check and try again.',
        'addon_uploaded_successfully' => 'File uploaded and extracted successfully.',
        'failed_to_extraction' => 'Failed to open the zip file for extraction.',
        'failed_to_open' => 'Failed to open the zip file.',
        'module_folder_already_exists' => 'The module folder already exists.',
    ...
    'queue' => [
        'patient_queue_system' => 'Patient Queue Management System',
        ...
        'queue' => 'Queue',
        'patient_name' => 'Patient Name',
        'attending_doctors' => 'Attending Doctors',
        'status' => 'Status',
