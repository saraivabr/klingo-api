...
return [
    ...
    */
    ...
    'custom_serial' => 'Número de Serie Personalizado',
    'custom_serial_prefix' => 'Prefijo de Número de Serie Personalizado',
    'prefix_tooltip' => 'Ingrese cualquier prefijo con letras y números (por ejemplo, ABC, ABC01). El sistema autoincrementará el último número (ABC01 → ABC02). Si no se encuentra ningún número, el numerado comenzará desde 1 o el número de inicio que haya establecido.',
    ...
    'bill' => [
        ...
        'note_Bill' => 'Nota: Después de agregar el cargo, deberás volver a generar la factura.',
    ...
    'appointment' => [
        ...
        'time' => 'Tiempo',
        'failed_to_validate_recaptcha' => 'La verificación de ReCaptcha falló',
        'you_can_not_delete' => 'La cita no se puede eliminar.',
    ],
    ...
    'currency' => [
        ...
        'in_use_cannot_delete' => 'en uso no se puede eliminar'
    ],
    ...
    'enquiry' => [
        ...
        'types' =>
        [
            'general_enquiry' => 'investigación general',
            'residential_care' => 'Cuidado residencial',
            'feedback/suggestions' => 'comentarios/sugerencias',
        ]
    ],
    ...
    'expense_head' => [
        'All' => 'Todos',
        'Building Rent' => 'Alquiler de Edificio',
        'Equipments' => 'Equipos',
        'Electricity Bill' => 'Factura de Electricidad',
        'Power Generator Fuel Charge' => 'Cargo por Combustible de Generador',
        'Telephone Bill' => 'Factura de Teléfono',
        'Tea Expense' => 'Gastos de Té',
    ],
    ...
    'incomes' => [
        'All' => 'Todos',
        'Hospital Charges' => 'Gastos del Hospital',
        'Special Campaign' => 'Campaña Especial',
        'Canteen Rent' => 'Alquiler de Cafetería',
        'Vehicle Stand Charges' => 'Cuotas de Estacionamiento',
    ...
    'vaccination' => [
        ...
        'brand' => 'Marca',
        'vaccinated' => 'Vacunado',
        'select_vaccination' => 'Seleccione Vacunación',
    ],
    ...
    'addon' => [
        ...
        'module_status_updated' => 'Estado del módulo Actualizado exitosamente',
        'disable' => 'Desactivar',
        'enable' => 'Permitir',
    ],
    'queue' => [
        'patient_queue_system' => 'Sistema de Gestión de Cola de Pacientes',
        ...
        'queue' => 'Cola',
        'patient_name' => 'Nombre del paciente',
        'attending_doctors' => 'Doctores tratantes',
        'status' => 'Estado',
        'no_patients_in_queue' => 'No hay pacientes en la cola',
    ],
];
