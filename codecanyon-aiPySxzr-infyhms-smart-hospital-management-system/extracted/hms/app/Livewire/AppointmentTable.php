...
class AppointmentTable extends LivewireTableComponent
{
    ...
    {
        $this->setDefaultSort('opd_date', 'desc');
    ...
    public function builder(): Builder
    {
        ...
        if (! getLoggedinDoctor()) {
            ...
            $query = Appointment::query()->select('appointments.*')->with(
                'patient',
                'doctor',
                'department'
        ...
        return $query->whereNotIn('is_completed', [Appointment::STATUS_IN_QUEUE, Appointment::STATUS_CHECK_IN]);
    }
}
